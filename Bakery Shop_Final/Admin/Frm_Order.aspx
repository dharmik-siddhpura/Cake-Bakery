<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Order.aspx.cs" MasterPageFile="~/Admin/MasterPage.master" Inherits="Admin_Frm_Order" %>
...
<asp:Content ID="C1" runat="server" ContentPlaceHolderID="CPH_ContentHolder" >
    ...
    <h5>From : <asp:TextBox ID="DateFrom" runat="server"  /> 
     ...
     <asp:Button ID="Date" runat="server" Text="OK" Width="60px" OnClick="Date_Click" CssClass="btn"/>
        <br/><br/>
